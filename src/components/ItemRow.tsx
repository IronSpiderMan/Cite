...
export function ItemRow({
  ...
  return (
    <div
      ...
      className={cn(
        'group border border-border/60 rounded-xl overflow-hidden bg-card hover:shadow-md hover:border-border/80 transition-all duration-300 cursor-pointer flex items-stretch h-20',
    ...
    >
      ...
      <div className="flex-1 px-4 py-3 flex items-center gap-4 min-w-0">
        <div className="min-w-0 flex-1">
          <div className="font-semibold text-sm truncate flex items-center gap-2" title={item.title}>
            {item.title}
